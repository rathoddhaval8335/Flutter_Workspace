...
class _ProjectDetailsScreenState extends State<ProjectDetailsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // floatingActionButton property removed from here
    );
  }
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              // Main content with proper gesture handling
              Column(
                children: [
                  // Clickable area for card (excluding dropdown area)
                  Expanded(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                // Dropdown area - this will handle its own taps
